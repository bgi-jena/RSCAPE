...
getSens <-function(
  ##title<< Estimate temperature sensitivty value and time varying $R_b$ from temperature and efflux time series including uncertainty.
  ##description<< Function to determine the temperature sensitivity sensitivity and time varying 
  ## basal efflux (R$_b(i)$) from a given transformed temperature and efflux (usually respiration) time series 
  ## according the principle of "SCAle dependent Parameter Estimation, SCAPE" (Mahecha et al. 2010). 
  ## This function should not be called directly please use getQ10, getArrhenius or getLloydTaylor instead. 
